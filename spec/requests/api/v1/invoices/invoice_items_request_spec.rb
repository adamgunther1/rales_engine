...
RSpec.describe "Invoices/InvoiceItems API" do
  context "GET /api/v1/invoices/:id/invoice_items" do
    it "sends all invoice_items" do
      invoice_item = create(:invoice_item)
      invoice_item2 = create(:invoice_item, invoice_id: invoice_item.invoice.id)

      get "/api/v1/invoices/#{invoice_item.invoice_id}/invoice_items"
